...
ROOT_URL=http://127.0.0.1/html5client MONGO_URL=mongodb://localhost:27017/html5client NODE_ENV=$ENVIRONMENT_TYPE PORT=3000 node main.js >/dev/null 2>&1 < /dev/null &
